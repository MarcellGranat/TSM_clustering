...
Látjuk, hogy egy keleti és egy nyugati blokkra hasad Európa, kivéve Portugáliát, és ezeken belül vannak karakteres részcsoportok. 'Data-driven' megközelítés.
...
```{r}
fviz_dend(hier, k=4, type = "circular")
```
